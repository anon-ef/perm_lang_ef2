...
lemma subst_type_preserve_app: "\<lbrakk> well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e tau r_se r_xe;
  well_typed env r_s2 e' t r_s3 rx2; rx1 (Var x) = NoPerm; x \<in> free_vars e; is_sexp e';
  ...
  well_typed env r_s1 (subst_exp e x e') tau (diff_use_env r_s3 (comp_use_env rx1 (lift_use_env rx2 r)))
...
lemma sstp_add_perms: "\<lbrakk> well_typed env (add_use_env r_s1 x r) e tau r_s2 rx;
  x \<notin> non_prim_vars env e \<rbrakk> \<Longrightarrow> well_typed env r_s1 e tau (rem_use_env r_s2 x) (rem_use_env rx x)"
  ...
  apply (rule_tac self_rem_leq_use_env)
    ...
    *)
lemma safe_subst_type_preserve_x: "\<lbrakk> well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 tau r_s' r_end; safe_subst_exp e1 x e' e2;
  is_sexp e'; well_typed env r_s2 e' t r_s3 rx2; leq_use_env r_s2 r_s1; leq_use_env rx1 r_s1;
  ...
  well_typed env r_s1 e2 tau (diff_use_env r_s3 (comp_use_env rx1 (lift_use_env rx2 r)))
    (diff_use_env (comp_use_env rx1 rx2) (comp_use_env rx1 (lift_use_env rx2 r)))"    
