...
lemma wtepl_conversion: "\<lbrakk> well_typed env r_s2a e tau r_s3 rx; leq_use_env r_s2a r_s1;
  well_typed env r_s1 e tau (diff_use_env r_s1 r_s1) (diff_use_env rx r_s1) \<rbrakk> \<Longrightarrow>
  well_typed env (super_norm_use_env r_s1 r_s2a) e tau (diff_use_env r_s1 r_s1) (diff_use_env rx r_s1)"
...
lemma well_typed_end_perm_lbound: "\<lbrakk> well_typed env r_s1 e tau r_s2 rx \<rbrakk> \<Longrightarrow> well_typed env r_s1 e tau (diff_use_env r_s1 r_s1) (diff_use_env rx r_s1)"    
    ...
    (* var case *)
      ...
      apply (auto)
        ...
        apply (rule_tac r_sb="r_s2" in trans_leq_use_env)
         apply (auto)
       apply (rule_tac id_leq_use_env)
      apply (rule_tac r_sb="diff_use_env (ereq_use_env (owner_name x) tau_x) (comp_use_env (comp_use_env (ereq_use_env (owner_name x) tau_x) r_ex) r_s1)" in trans_leq_use_env)
