...
lemma well_typed_sstr_end_perm: "\<lbrakk> well_typed env r_s1 e tau r_s2 rx \<rbrakk> \<Longrightarrow> well_typed env r_s1 e tau (super_norm_use_env r_s1 r_s2) rx"   
