...
lemma unpack_pair_type: "\<lbrakk> well_typed env r_s1 (upc_init_abbrev v1 v2) t2 r_s2 rx; is_value v1; is_value v2;
  ...
  (\<exists> rx1 rx2 r_ex.
    well_typed env rx1 v1 t1a rx1 rx1 \<and> well_typed env rx2 v2 t2a rx2 rx2 \<and> rx1 (Var f) = NoPerm \<and> rx2 (Var f) = NoPerm \<and>
       ...
       \<Longrightarrow> \<exists>g_ax. (\<exists>rxa. (\<exists>r_end r_s' t1 ra a r_s2 rx1.
                             (\<exists>t1b rb. (\<exists>aa. add_env (red_env env g_ax) (Var f) (FunTy t1a (FunTy t2a tx r (as_aff r')) r (as_aff r')) (Var f) =
                                       ...
                                       (\<exists>r_s2a rx1a.
                                           ...
                                           (\<exists>rx2 r_s3. well_typed (add_env (red_env env g_ax) (Var f) (FunTy t1a (FunTy t2a tx r (as_aff r')) r (as_aff r')))
                             ...
                             (\<exists>rx2 r_s3. well_typed (add_env (red_env env g_ax) (Var f) (FunTy t1a (FunTy t2a tx r (as_aff r')) r (as_aff r'))) r_s2 v2 t1 r_s3
                                          rx2 \<and>
                  ...
                  proper_exp (red_nres_map rs_map g_ax) (LamExp f (AppExp (AppExp (VarExp (VarType f)) v1) v2)) \<and>
