...
lemma wt_sexp_no_npv_use: "\<lbrakk> well_typed env r_s1 e tau r_s2 rx; is_sexp e; req_type tau = Prim \<rbrakk> \<Longrightarrow> x \<notin> non_prim_vars env e"    
...
lemma subst_type_preserve_prim_fv: "\<lbrakk> well_typed (add_env env (Var x) t) r_s1 e tau r_se r_xe;
  well_typed env rx2 e' t rx2 rx2; is_sexp e'; req_type t = Prim; lam_vars e \<inter> free_vars e' = {} \<rbrakk> \<Longrightarrow>
  well_typed env r_s1 (subst_exp e x e') tau r_se r_xe"
...
lemma subst_type_preserve_no_npv: "\<lbrakk> well_typed (add_env env (Var x) t) r_s1 e tau r_se r_xe;
  well_typed env rx2 e' t rx2 rx2; is_sexp e'; (Var x) \<notin> non_prim_vars (add_env env (Var x) t) e;
...
lemma well_typed_stpx_req2:
  "\<lbrakk> well_typed env r_s1 e tau r_se r_xe; leq_perm q r; leq_use_env rx2_c rx2; disj_use_env r_s1 rx2 \<rbrakk> \<Longrightarrow>
  well_typed env (stpx_req r_s1 rx2 r) e tau (stpx_req r_se rx2 r) (stpx_req r_xe rx2_c q)"
...
lemma well_typed_diff_decr_end_neg_perm: "\<lbrakk>
  well_typed env (diff_use_env r_s1 (end_neg_use_env r_s x r_ex r)) e tau (diff_use_env r_s2 (end_neg_use_env r_s x r_ex r))
  ...
  well_typed env (diff_use_env r_s1 (end_neg_use_env r_s x r_ex r)) e tau (diff_use_env r_s2 (end_neg_use_env r_x x r_ex r))
...
lemma stpx_var_case: "\<lbrakk>well_typed env rx2 e' t rx2 rx2; rx1 (Var xa) = NoPerm; xa \<in> (case x of VarType x \<Rightarrow> {x} | LocType list1 list2 \<Rightarrow> {}); is_sexp e';
        ...
        add_env env (Var xa) t (owner_name x) = Some tau_x; value_req x tau tau_x; leq_use_env (ereq_use_env (owner_name x) tau_x) (add_use_env rx1 (Var xa) r);
        leq_use_env r_se (diff_use_env (add_use_env rx1 (Var xa) r) (comp_use_env (ereq_use_env (owner_name x) tau_x) r_ex)); leq_use_env r_xe r_se;
        leq_use_env r_ex (add_use_env rx1 (Var xa) r);
        leq_use_env (diff_use_env (ereq_use_env (owner_name x) tau_x) (comp_use_env (ereq_use_env (owner_name x) tau_x) r_ex)) r_xe\<rbrakk>
       \<Longrightarrow> well_typed env r_s1 (subst_exp (VarExp x) xa e') tau
...
lemma stpxic_valid_diff: "\<lbrakk> xa \<in> non_prim_vars env (subst_exp e2 x e'); xa \<in> own_env_vars (end_neg_use_env r_s2 (Var x) rx2 r);
  x \<in> free_vars e2; well_typed env rx2 e' t rx2 rx2; is_sexp e'; disj_use_env rx1 (lift_use_env rx2 r);
  well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 tau' r_s2 rx'; well_typed (add_env env (Var x) t) r_s2 e2 tau r_se rx \<rbrakk> \<Longrightarrow> False"    
...
lemma stpxpc_coercex: "\<lbrakk>\<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
           \<lbrakk>well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 tau r_se r_xe; well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm;
           ...
           \<Longrightarrow> well_typed env r_s1 (subst_exp e1 x e') tau
  ...
  well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 tau r_se r_xe; well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm;
  ...
  \<rbrakk> \<Longrightarrow> well_typed env r_s1 (subst_exp e1 x e') tau
                (diff_use_env (comp_use_env (rem_use_env r_se (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_se (Var x) rx2 r))
                (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r))"    
  apply (auto)
  done
...
lemma stpx_pair_case: "\<lbrakk>\<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
        ...
        \<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
           \<lbrakk>well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e2 tau r_se r_xe; well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm;
           ...
           \<Longrightarrow> well_typed env r_s1 (subst_exp e2 x e') tau
                (diff_use_env (comp_use_env (rem_use_env r_se (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_se (Var x) rx2 r))
                (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r));
        well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm; is_sexp e'; (lam_vars e1 \<union> lam_vars e2) \<inter> free_vars e' = {};
        leq_use_env (comp_use_env rx1 (lift_use_env rx2 r)) r_s1; disj_use_env rx1 (lift_use_env rx2 r);
        well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 t1 r_s2 rx1a; well_typed (add_env env (Var x) t) r_s2 e2 t2 r_s3 rx2a;
       ...
       \<Longrightarrow> \<exists>r_s2 r_s3 rx1.
              well_typed env r_s1 (subst_exp e1 x e') t1 r_s2 rx1 \<and>
              (\<exists>rx2a. well_typed env r_s2 (subst_exp e2 x e') t2 r_s3 rx2a \<and>
  ...
  apply (auto)
      apply (case_tac "\<not> well_typed (add_env env (Var x) t) (add_use_env (rem_use_env r_s2 (Var x)) (Var x) (r_s2 (Var x))) e2 t2 r_s3 rx2a")
    ...
    (* x \<in> fv e2. we start by removing end_neg r_s2 x  *)
      apply (case_tac "\<not> (non_prim_vars env (subst_exp e2 x e') \<inter> own_env_vars (end_neg_use_env r_s2 (Var x) rx2 r) = {})")
       apply (auto)
...
lemma stpx_if_no_fv: "\<lbrakk>
     ...
     well_typed (add_env env (Var x) t) r_s1 e tau r_s2 rx'; leq_perm (rx' (Var x)) r; x \<notin> free_vars e \<rbrakk>
    \<Longrightarrow> well_typed env (diff_use_env (comp_use_env (rem_use_env r_s1 (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_s2 (Var x) rx2 r)) (subst_exp e x e') tau
...
lemma stpx_if_case: "\<lbrakk>\<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
        ...
        \<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
           ...
           \<Longrightarrow> well_typed env r_s1 (subst_exp e2 x e') tau
                ...
                (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r));
        \<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
           \<lbrakk>well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e3 tau r_se r_xe; well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm;
           ...
           \<Longrightarrow> well_typed env r_s1 (subst_exp e3 x e') tau
                (diff_use_env (comp_use_env (rem_use_env r_se (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_se (Var x) rx2 r))
                (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r));
        well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm; is_sexp e'; (lam_vars e1 \<union> lam_vars e2 \<union> lam_vars e3) \<inter> free_vars e' = {};
        leq_use_env (comp_use_env rx1 (lift_use_env rx2 r)) r_s1; disj_use_env rx1 (lift_use_env rx2 r);
        well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 BoolTy r_s2 rx'; well_typed (add_env env (Var x) t) r_s2 e2 tau r_se rx1a;
        well_typed (add_env env (Var x) t) r_s2 e3 tau r_se rx2a\<rbrakk>
  ...
  apply (auto)
   ...
   apply (case_tac "\<not> well_typed (add_env env (Var x) t) (add_use_env (rem_use_env r_s2 (Var x)) (Var x) r) e2 tau r_se rx1a")
  ...
  apply (auto)
   ...
   apply (case_tac "\<not> well_typed (add_env env (Var x) t) (add_use_env (rem_use_env r_s2 (Var x)) (Var x) r) e3 tau r_se rx2a")
...
lemma stpx_lam_case: "\<lbrakk>\<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
           \<lbrakk>well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e tau r_se r_xe; well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm;
            x \<in> free_vars e; leq_use_env (comp_use_env rx1 (lift_use_env rx2 r)) r_s1; disj_use_env rx1 (lift_use_env rx2 r)\<rbrakk>
           \<Longrightarrow> well_typed env r_s1 (subst_exp e x e') tau
                (diff_use_env (comp_use_env (rem_use_env r_se (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_se (Var x) rx2 r))
                (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r));
        well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm; is_sexp e'; leq_use_env (comp_use_env rx1 (lift_use_env rx2 r)) r_s1;
        disj_use_env rx1 (lift_use_env rx2 r); x \<in> free_vars e; x \<noteq> x1a; x1a \<notin> free_vars e'; lam_vars e \<inter> free_vars e' = {};
        well_typed (add_env (add_env env (Var x) t) (Var x1a) t1) (add_use_env rx (Var x1a) ra) e t2 r_s' r_end; aff_use_env rx a;
       ...
       \<Longrightarrow> \<exists>rx. (\<exists>r_end r_s'. well_typed (add_env env (Var x1a) t1) (add_use_env rx (Var x1a) ra) (subst_exp e x e') t2 r_s' r_end) \<and>
  ...
  apply (auto)
    ...
    *)
    ...
    (* - we're allowed to add x to rx (after removing some original value of x to further facilitate induction) *)
     apply (case_tac "\<not> well_typed (add_env (add_env env (Var x1a) t1) (Var x) t) (add_use_env (rem_use_env (add_use_env rx (Var x1a) ra) (Var x)) (Var x) (rx (Var x))) e t2 r_s' r_end")
    ...
    (* - manipulation of the rx2 well-typedness constraint, so that we can remove x1a from it. *)
     apply (case_tac "\<not> well_typed (add_env env (Var x1a) t1) (rem_use_env (drop_use_env_ex rx2 (rx (Var x))) (Var x1a)) e' t
...
lemma stpx_app_case: "\<lbrakk>\<And>env x tau t rx1 r_se r_xe r_s1 rx2 r.
        ...
        well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm; is_sexp e'; (lam_vars e1 \<union> lam_vars e2) \<inter> free_vars e' = {};
        leq_use_env (comp_use_env rx1 (lift_use_env rx2 r)) r_s1; disj_use_env rx1 (lift_use_env rx2 r);
        well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e1 (FunTy t1 tau ra a) r_s2 rx1a; well_typed (add_env env (Var x) t) r_s2 e2 t1 r_s3 rx2a;
...
(* - with that in mind we can remove the subtraction from the start permissions *)
   ...
   apply (case_tac "\<not> well_typed (add_env env (Var x) t) (add_use_env (rem_use_env r_s2 (Var x)) (Var x) (r_s2 (Var x))) e2 t1 r_s3 rx2a")
    apply (cut_tac r_s="r_s2" and x="Var x" and r="r_s2 (Var x)" in cancel_add_rem_use_env)
     apply (simp_all)
...
lemma subst_type_preserve_x: "\<lbrakk> well_typed (add_env env (Var x) t) (add_use_env rx1 (Var x) r) e tau r_se r_xe;
  well_typed env rx2 e' t rx2 rx2; rx1 (Var x) = NoPerm; x \<in> free_vars e; is_sexp e'; (*r \<noteq> NoPerm;*)
  ...
  well_typed env r_s1 (subst_exp e x e') tau (diff_use_env (comp_use_env (rem_use_env r_se (Var x)) (lift_use_env rx2 r)) (end_neg_use_env r_se (Var x) rx2 r))
    (diff_use_env (stpx_req (rem_use_env r_xe (Var x)) (lift_use_env rx2 (r_xe (Var x))) (r_xe (Var x))) (end_neg_use_env r_se (Var x) rx2 r))"
